...
//----------------------------------------
// volatile uint8_t left_last_pos = 0;
// volatile uint8_t right_last_pos = 0;
...
void DMA1_Channel1_IRQHandler() {
  ...
  //----------------------------------------------------------------------------
  // HAL_GPIO_WritePin(INTERRUPT_PORT, LEFT_INTERRUPT_PIN,0);
  // HAL_GPIO_WritePin(INTERRUPT_PORT, RIGHT_INTERRUPT_PIN,0);

  // if(left_last_pos != posl){
  //   HAL_GPIO_WritePin(INTERRUPT_PORT, LEFT_INTERRUPT_PIN,1);
  //   left_last_pos = posl; 
  //   // left_state = 1 - left_state;
  // }

  // if(right_last_pos != posr){
